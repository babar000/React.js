...
function App() {
  ...
  const passwordGenerator = useCallback(()=>{
    let pass = ""
    let str = "ABCDEFGHIJKLMNOPQRSTWXYZabcdefghijklmonopqrstwxyz"
    ...
    <>
     <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 text-orange-500 bg-gray-700">
      ...
      <div className='flex shadow rounded-lg  overflow-hidden mb-4'>
        ...
        <button onClick={copyPasswordToClipboard} className='bg-blue-700 text-white px-3 py-0.5 sharink-0 outline-none'>Copy</button>
      </div>
